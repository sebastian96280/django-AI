...
DOMINIO_RENDER = os.getenv('DOMINIO_RENDER', 'http://127.0.0.1:8000')
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'jhoan.96280@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'ndmbsetlqjitdcrk')
